 ...
 *           &lt;element name="valueEqualTo" type="{}valueEqualTo"/>
 *           &lt;element name="codeSet" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
 *         &lt;/choice>
...
public class FieldTest {
    ...
    protected ValueEqualTo valueEqualTo;
    protected List<String> codeSet;
     ...
     *     
     */
    public ValueEqualTo getValueEqualTo() {
        return valueEqualTo;
    }
     ...
     *     
     */
    public void setValueEqualTo(ValueEqualTo value) {
     ...
     * 
     */
    public List<String> getCodeSet() {
        if (codeSet == null) {
            codeSet = new ArrayList<String>();
        }
        return this.codeSet;
    }
