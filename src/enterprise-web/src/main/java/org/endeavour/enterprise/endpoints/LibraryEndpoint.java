...
public final class LibraryEndpoint extends AbstractItemEndpoint {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    @Path("/getTermChildren")
    public Response getTermChildren(@Context SecurityContext sc, @QueryParam("code") String code) throws Exception {
        super.setLogbackMarkers(sc);

        List<Object[]> terms = TermsEntity.getTermChildren(code);
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Path("/getTermParents")
    public Response getTermParents(@Context SecurityContext sc, @QueryParam("code") String code) throws Exception {
        super.setLogbackMarkers(sc);

        List<Object[]> terms = TermsEntity.getTermParents(code);
