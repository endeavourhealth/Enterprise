...
class FieldCompilerTest {
    ...
    void fieldCompiler_lessThanDecimal_success() {
        ...
        def from = new ValueTo(operator: ValueToOperator.LESS_THAN, constant: "50.5", absoluteUnit: ValueAbsoluteUnit.NUMERIC);
    ...
    void fieldCompiler_lessThanOrEqualToDecimal_success() {
        ...
        def from = new ValueTo(operator: ValueToOperator.LESS_THAN_OR_EQUAL_TO, constant: "50.5", absoluteUnit: ValueAbsoluteUnit.NUMERIC);
