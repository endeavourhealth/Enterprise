...
public class TokenHelper {
    ...
    public static NewCookie createTokenAsCookie(String host, String person, String org, boolean isAdmin, boolean isSuperUser) {
        String token = createToken(host, person, org, isAdmin, isSuperUser);
        return createCookie(token);
    }

    private static String createToken(String host, String person, String org, boolean isAdmin, boolean isSuperUser) {
        ...
        if (person != null) {
            bodyParameterMap.put(TOKEN_USER, person);
        }
        ...
        if (org != null) {
            bodyParameterMap.put(TOKEN_ORGANISATION, org);
        }
